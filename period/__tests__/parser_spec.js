...
function doPeriodTest(id) {
  expect((0, _parser.getPeriodFromPeriodId)(id)).toEqual(periodFixtures[id]);
}

describe('getPeriodFromPeriodId(periodId, locale) period parser', function () {
  describe('for Daily periods', function () {
    it('should handle valid Daily periods', function () {
      doPeriodTest('19810331');
      doPeriodTest('20171231');
      doPeriodTest('20040229');
    }); // it('should handle Daily periods in French');

    it('should accept nearly valid Daily periods', function () {
      doPeriodTest('20170229');
    });
    it('should not accept invalid Daily periods', function () {
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('19813103');
      }).toThrowError();
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('20170000');
      }).toThrowError();
    });
  });
  describe('for Weekly periods', function () {
    it('should handle valid Weekly periods', function () {
      doPeriodTest('2017W4');
      doPeriodTest('1981W37');
    }); // it('should handle Weekly periods in French');

    it('should handle Week 1 that starts the previous year', function () {
      doPeriodTest('2015W1');
      doPeriodTest('1981W1');
    });
    it('should handle Week 53 for 53-week years', function () {
      doPeriodTest('2015W53');
    });
    it('should handle Week 53 for 52-week years', function () {
      doPeriodTest('2016W53');
    });
    it('should handle weeks that end the following year', function () {
      doPeriodTest('2016W52');
    });
    it('should not accept week numbers higher than 53', function () {
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('2017W54');
      }).toThrowError();
    });
    it('should not accept week numbers below 1', function () {
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('2017W0');
      }).toThrowError();
    });
    it('should handle Week 1-9 with leading zero', function () {
      doPeriodTest('2017W04');
    });
    it('should handle Weekly Wednesday period types', function () {
      doPeriodTest('2017WedW4');
    });
    it('should handle Weekly Thursday period types', function () {
      doPeriodTest('2017ThuW4');
    });
    it('should handle Weekly Saturday period types', function () {
      doPeriodTest('2017SatW4');
    });
    it('should handle Weekly Sunday period types', function () {
      doPeriodTest('2017SunW4');
    });
  });
  describe('for BiWeekly periods', function () {
    it('should handle valid BiWeekly periods', function () {
      doPeriodTest('2019BiW12');
    });
    it('should handle BiWeek 1-9 with leading zero', function () {
      doPeriodTest('2019BiW04');
    });
    it('should handle BiWeek 1 that starts the previous year', function () {
      doPeriodTest('2015BiW1');
    });
    it('should handle BiWeek 27 for 52-week years', function () {
      doPeriodTest('2016BiW27');
    });
    it('should handle BiWeek 27 for 53-week years', function () {
      doPeriodTest('2015BiW27');
    });
    it('should not accept BiWeek numbers higher than 27', function () {
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('2017BiW28');
      }).toThrowError();
    });
    it('should not accept BiWeek numbers below 1', function () {
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('2017BiW0');
      }).toThrowError();
    });
  });
  describe('for Monthly periods', function () {
    it('should handle valid Monthly periods', function () {
      doPeriodTest('198103');
    }); // it('should handle Monthly periods in French');

    it('should handle February properly in leap years', function () {
      doPeriodTest('198002');
    });
    it('should handle February properly in normal years', function () {
      doPeriodTest('198102');
    });
    it('should not accept invalid Monthly periods', function () {
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('193414');
      }).toThrowError();
    });
  });
  describe('for BiMonthly periods', function () {
    it('should handle valid BiMonthly periods', function () {
    ...
    it('should not accept invalid BiMonthly periods without leading zeros', function () {
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('19812B');
      }).toThrowError();
    });
    it('should not accept BiMonthly periods above 6', function () {
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('198107B');
      }).toThrowError();
    });
    it('should not accept BiMonthly periods below 1', function () {
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('198100B');
      }).toThrowError();
    });
  });
  describe('for Quarterly periods', function () {
    it('should handle Quarters 1-4', function () {
      doPeriodTest('1981Q1');
      doPeriodTest('1981Q2');
      doPeriodTest('1981Q3');
      doPeriodTest('1981Q4');
    ...
    it('should not accept Quarters below 1 or above 4', function () {
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('1981Q0');
      }).toThrowError();
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('2017Q5');
      }).toThrowError();
    });
  });
  describe('for SixMonthly periods', function () {
    it('should handle valid SixMonthly periods', function () {
      doPeriodTest('1981S1');
      doPeriodTest('1981S2');
    }); // it('should handle SixMonthly periods in French');

    it('should not accept SixMonthly periods below 1 or above 2', function () {
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('1981S0');
      }).toThrowError();
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('1981S3');
      }).toThrowError();
    });
  });
  describe('for SixMonthlyApril periods', function () {
    it('should handle valid SixMonthlyApril periods', function () {
      doPeriodTest('1981AprilS1');
      doPeriodTest('1981AprilS2');
    }); // it('should handle SixMonthlyApril periods in French');

    it('should not accept SixMonthlyApril periods below 1 or above 2', function () {
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('1981AprilS0');
      }).toThrowError();
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('1981AprilS3');
      }).toThrowError();
    });
  });
  describe('for Yearly periods', function () {
    it('should handle valid Yearly periods', function () {
      doPeriodTest('1981');
      doPeriodTest('2017');
    });
  });
  describe('for FinancialApril periods', function () {
    it('should handle FinancialApril periods', function () {
  ...
  describe('for FinancialJuly periods', function () {
    it('should handle FinancialJuly periods', function () {
  ...
  describe('for FinancialOct periods', function () {
    it('should handle FinancialOct periods', function () {
  ...
  describe('for invalid periods', function () {
    it('should not accept invalid periods', function () {
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('test');
      }).toThrowError();
      expect(function () {
        return (0, _parser.getPeriodFromPeriodId)('1234567890');
      }).toThrowError();
    });
  });
});
