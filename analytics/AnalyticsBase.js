...
function () {
  ...
  _createClass(AnalyticsBase, [{
    ...
    value: function get(req) {
      ...
      var dataReq = new _AnalyticsRequest.default(req).withSkipData(false).withSkipMeta(true).withIncludeNumDen(req.parameters.includeNumDen).withDisplayProperty('SHORTNAME'); // parallelize requests
