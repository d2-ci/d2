...
var _AnalyticsResponseHeader = require('./AnalyticsResponseHeader');

var _AnalyticsResponseHeader2 = _interopRequireDefault(_AnalyticsResponseHeader);
    ...
    _createClass(AnalyticsResponse, [{
        ...
        value: function extractHeaders() {
            ...
            return headers.map(function (header, index) {
                return new _AnalyticsResponseHeader2.default(header, {
        ...
        value: function extractRows() {
            ...
            if (headersWithOptionSet.length) {
                ...
                var optionCodeIdMap = this.optionCodeIdMap();
        ...
        value: function extractMetadata() {
            ...
            var metaData = _extends({}, this.response.metaData);
        ...
        value: function optionCodeIdMap() {
            var _response$metaData = this.response.metaData,
                dimensions = _response$metaData.dimensions,
                items = _response$metaData.items;
...
exports.default = AnalyticsResponse;
